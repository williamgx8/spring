...
public class ClassPathMapperScanner extends ClassPathBeanDefinitionScanner {
    ...
    public void registerFilters() {
        ...
        //如果@MapperScan配置了annotationClass属性，那么该类肯定是要扫描进去的
    ...
    /**
     * 扫描根目录，解析根目录中所有符合条件的类，生成类对应的BeanDefinition，此时类的实例
     * 并没有被创建
    ...
    public Set<BeanDefinitionHolder> doScan(String... basePackages) {
        //扫包下所有Mapper接口，创建对象，并进行spring注册
    ...
    private void processBeanDefinitions(Set<BeanDefinitionHolder> beanDefinitions) {
        ...
        for (BeanDefinitionHolder holder : beanDefinitions) {
            ...
            //BeanDefinition的ConstructorArgsValues中塞入generic参数 类名
            definition.getConstructorArgumentValues().addGenericArgumentValue(beanClassName); // issue #59
            //所有BeanDefinition都是MapperFactoryBean的子类
            definition.setBeanClass(this.mapperFactoryBean.getClass());

            //类属性添加addToConfig，默认为true
            definition.getPropertyValues().add("addToConfig", this.addToConfig);

            //是否明确指明SqlSessionFactory
            boolean explicitFactoryUsed = false;
            if (StringUtils.hasText(this.sqlSessionFactoryBeanName)) {
                //相当于加了<bean id = "sqlSessionFactory" ref = "xxx"/>的配置
